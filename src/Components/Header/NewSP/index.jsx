              ...
              <div className="new_product-img">
                <a href="/" className="new_product-link">
                  <span className="new_product-linkImg">
                    <img src="https://img.abaha.vn/photos/resized/825x416/121-1608210033-demoweb.png" alt="" />
                  </span>
                </a>
              </div>
              <div className="new_product-name">
                <div className="new_product-info">
                  <h2 className="new_product-title">
                    <a href className="new_product-link">Chương trình khách hàng thân thiết</a>
                  </h2>
